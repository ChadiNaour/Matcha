...
const Routes = (props) => {
    ...
    return (
            <Switch>
                <Route exact path="/register" component={user === null ? RegisterUser  : (user.step === 3 ? Browse : Profile)} />
                <Route exact path="/login" component={user === null ? loginUser  : (user.step === 3 ? Browse : Profile)} />
                <Route exact path="/Browser" component={user === null ? loginUser : (user.step === 3 ? Browse : Profile)} />
                <Route exact path="/profile" component={user === null ? loginUser : (user.step === 3 ? Browse : Profile) }/>
                ...
                <Route exact path="/confirme/:token" component={user === null ? confirme  : (user.step === 3 ? Browse: Profile)} />
                <Route exact path="/resetPassword/:token" component={user === null ? ResetPassword  : (user.step === 3 ? Browse : Profile)} />
                {/* <Route exact path="/chat" component={user !== null  ? (user.step === 3 ? Chat : Profile) : loginUser }/>  */}
                <Route exact path="/forgotPassword" component={user === null ? ForgotPassword  : (user.step === 3 ? Browse : Profile)} />
                <Route exact path="/edit_profile" component={user === null ? loginUser  : (user.step === 3 ? EditProfile : Profile)} />
                <Route exact path="/" component={user === null ? loginUser  : (user.step === 3 ? Browse : Profile)} />
