...
export default function ViewProfile(props) {
  const {user,images,tags,handleBlock,handleLike,handleDislike,handleViewProfile} = props;
  ...
  return (
    ...
    <Card className={classes.card}>
      ...
      <CardActions className={classes.cardAction}>
        ...
        <Tooltip title ="View"><IconButton aria-label="View"  onClick={(e) => handleViewProfile(user,images,tags)}>
